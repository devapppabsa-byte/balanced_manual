            ...
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between flex-wrap">
                    ...
                    <div class="mt-2 mt-md-0 d-flex gap-2">
                        <button class="btn btn-danger" data-mdb-ripple-init data-mdb-modal-init data-mdb-target="#deleteAllProveedores">
...
<div class="modal fade" id="deleteAllProveedores" tabindex="-1" aria-labelledby="deleteAllProveedoresLabel" aria-hidden="true" data-mdb-backdrop="static">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header bg-danger text-white border-0 py-3">
                <h5 class="modal-title fw-bold" id="deleteAllProveedoresLabel">
                    <i class="fa-solid fa-triangle-exclamation me-2"></i>
            ...
            <div class="modal-body py-4">
                <div class="text-center mb-4">
                    ...
                    <h6 class="fw-semibold">¿Estás seguro de eliminar todos los proveedores?</h6>
                    <small class="text-muted d-block mt-2">
                        Esta acción eliminará todos los proveedores y sus evaluaciones, no se puede deshacer.
                    </small>
                </div>
                <form action="{{route('proveedor.delete.all')}}" method="POST">
                    @csrf @method('DELETE')
                    <div class="d-flex gap-2">
                        <button type="button" class="btn btn-outline-secondary flex-fill" data-mdb-ripple-init data-mdb-dismiss="modal">
                            Cancelar
