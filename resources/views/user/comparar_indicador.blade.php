...
<div class="row">
    <div class="card border-0 shadow-sm">
        <div class="card-body py-3 px-4">
            ...
            <form action="{{ route('comparar.indicador.usuario', $indicador->id) }}" method="GET" id="filtro_comparar">
                <div class="row g-3 align-items-end">

                    <div class="col-4 col-md-auto">
                        <a href="{{ route('analizar.indicador.usuario', $indicador->id) }}" class="btn btn-secondary btn-sm px-3">
